CC = g++
CFLAGS = -std=c++11 -m64 -Wall -pedantic -O4 -march=native -flto -funroll-loops -ftree-vectorize -ftree-vectorizer-verbose=5
...
endgame.o: endgame.hpp endgame.cpp
	$(CC) $(CFLAGS) -c endgame.cpp
